...
class App extends React.Component {
    ...
    render(){
        return <div id="wrapper">
            ...
            <p id="description">This online utility allows you to modify a Hollow Knight save file. View the source code in the <a href="https://github.com/bloodorca/hollow">github repo</a>.</p>
            <ul id="instructions">
